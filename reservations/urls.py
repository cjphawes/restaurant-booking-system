...
from .views import ReservationView, ContactView, MenuView, ReviewView, leave_review, make_reservation, list_reservations, update_reservation, remove_reservation
...
urlpatterns = [
    ...
    path("remove_reservation/<int:reservation_id>/", remove_reservation, name="reservationRemove"),
